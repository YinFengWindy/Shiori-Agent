...
| 桌宠语音 | `desktop/src/voice/`、`desktop/renderer/src/voice/`、`desktop_bridge/voice/voice_service.py`、`desktop_bridge/voice/tts_coordinator.py` | 录音、ASR、角色 Loop、按句 TTS、播放与中断 |
