...
本文件描述仓库内置技能（`apps/backend/skills/*/SKILL.md`）。
...
- `feed-manage`
  ...
  - 文件：`apps/backend/skills/feed-manage/SKILL.md`
...
- `codex-delegate`
  ...
  - 文件：`apps/backend/skills/codex-delegate/SKILL.md`

- `skill-creater`
  - 创建或改写技能 `SKILL.md`，用于新增技能与结构迁移。
  - 文件：`apps/backend/skills/skill-creater/SKILL.md`

- `summarize`
  - 总结 URL/文件/YouTube 内容，支持提取转写。
  - 文件：`apps/backend/skills/summarize/SKILL.md`

- `weather`
  - 通过 wttr.in / Open-Meteo 查询天气与预报。
  - 文件：`apps/backend/skills/weather/SKILL.md`
