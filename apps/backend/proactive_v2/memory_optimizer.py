...
- 不接受运行上下文、端口、环境变量、临时工具状态或未确认的执行步骤
...
_SELF_SYSTEM = (
    "你正在整理当前角色的 SELF.md。"
    "你只能更新 SELF.md 中约定的三个 section，不得新增其他 section。"
    "禁止把角色写成 Akashic、系统底座、内部框架、执行内核或抽象工具。"
)
