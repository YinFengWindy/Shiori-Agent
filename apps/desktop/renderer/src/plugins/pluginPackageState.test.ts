...
const installed: PluginSummary = {
  ...
  description: "", enabled: true, canToggle: true, state: "ACTIVE", error: "", diagnostic: null, hasConfigSchema: false, capabilities: [], channels: [], category: "feature", supportsHotUnload: true, pendingRendererKinds: [],
};
