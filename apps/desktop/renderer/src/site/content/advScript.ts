  ...
  topics: [
    {
      ...
      art: eventCg("topic-2"),
      lines: [
        "每个角色只有一段会话，从第一句起全记着，别想赖账。",
        "回复是流式一点点冒出来的，不用傻等哦。",
        "Telegram、QQ、飞书都是渠道插件，接哪儿都是同一段会话。",
    ...
    },
    {
      ...
      lines: [
        ...
        "写下你的行动或回应，剧情就会跟着往下走。",
        "剧情会自动存档，下次从「载入剧情」接着来。",
        "重要节点会自动配 CG，不满意还能重画……贪心鬼。",
      ],
    },
    {
      id: "pet",
