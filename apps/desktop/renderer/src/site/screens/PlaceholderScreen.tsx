...
export function PlaceholderScreen({ title, body, onBack }: PlaceholderScreenProps) {
  return (
    <div className="site-screen relative grid h-dvh min-h-0 place-items-center overflow-hidden px-6 text-center">
      <SiteScene />
      <div className="site-panel relative flex flex-col items-center gap-4 rounded-xl px-10 py-12">
