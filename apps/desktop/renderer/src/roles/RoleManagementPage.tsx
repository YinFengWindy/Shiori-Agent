            ...
            {roles.map((role) => {
              ...
              return (
                <button
                  ...
                  className={cx(
                    "group relative grid h-[420px] w-full overflow-hidden rounded-xl border border-line-soft bg-surface-soft text-left shadow-soft transition-[transform,box-shadow] duration-base hover:-translate-y-0.5 hover:shadow-pop motion-reduce:transform-none disabled:cursor-default disabled:opacity-60",
                    focusResetClass,
                    isActive && "shadow-pop",
                  )}
