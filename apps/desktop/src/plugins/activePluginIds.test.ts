...
test("main-process admission requires ACTIVE and rejects every duplicate in any order", () => {
  const rejected = ["UNTRUSTED", "CONFLICT", "BLOCKED", "FAILED", "RESTART_REQUIRED", "DISCOVERED", "DISABLED"];
