...
export function WorldGameControls({ paused, onPause, onResume, onSkip, onRedraw, onOpenTimeline, onExitWorkspace }: WorldGameControlsProps) {
  ...
  return (
    <>
      <div className="absolute right-5 top-5 z-20 flex items-center gap-2 text-white">
