  ...
  return (
    <div className="app-frame grid h-screen grid-rows-app overflow-hidden bg-[var(--app-bg)]">
      ...
      >
        ...
        />
        <main className="chat-pane relative grid min-h-0 grid-cols-[minmax(0,1fr)] overflow-hidden rounded-l-[16px] bg-white shadow-[0_18px_42px_rgba(75,43,18,0.12)] ring-1 ring-black/5">
          <ChatSurface
