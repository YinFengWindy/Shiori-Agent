...
describe("buildStoryArchiveDays", () => {
  it("groups dates and time periods while distinguishing narration, dialogue, and player entries", () => {
    const story = createStoryDetails({
      beats: [
        createStoryBeat({ id: "narration", kind: "narration", speaker: null, timeBand: "上午", text: "雨停了。", recordedAt: "2026-08-02T10:00:00+08:00" }),
        createStoryBeat({ id: "dialogue", kind: "dialogue", speaker: "哈风", timeBand: "上午", text: "你来了。", recordedAt: "2026-08-02T10:02:00+08:00" }),
        createStoryBeat({ id: "night", kind: "dialogue", speaker: "哈风", timeBand: "夜晚", text: "灯亮了。", recordedAt: "2026-08-03T20:00:00+08:00" }),
      ],
